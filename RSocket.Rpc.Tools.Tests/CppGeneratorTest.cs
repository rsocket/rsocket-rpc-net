...
namespace RSocket.Rpc.Tools.Tests
{
    public class CppGeneratorTest : GeneratorTest
    {
        ...
        [Test]
        public void NoRSocketRpcTwoOutputs()
        {
        ...
        [TestCase("false")]
        [TestCase("")]
        public void RSocketRpcDisabledTwoOutput(string services)
        {
        ...
        [TestCase("true")]
        public void RSocketRpcEnabledFourOutputs(string services)
        {
            var item = Utils.MakeItem("foo.proto", "RSocketRpcServices", services);
            var poss = _generator.GetPossibleOutputs(item);
            ...
            Assert.Contains("foo_rsocket_rpc.pb.cc", poss);
            Assert.Contains("foo_rsocket_rpc.pb.h", poss);
        }
