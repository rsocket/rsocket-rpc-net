...
namespace RSocket.Rpc.Tools
{
    ...
    public class ProtoCompile : ToolTask
    {
        ...
        */
        ...
        /// <summary>
        /// Full path to the RSocket RPC plugin executable. If specified, RSocket RPC generation
        /// is enabled for the files.
        /// Switch: --plugin=protoc-gen-rsocket_rpc=
        /// </summary>
        public string RSocketRpcPluginExe { get; set; }

        /// <summary>
        /// Generated RSocket RPC  directory. The generator property determines the
        /// language. If RSocket RPC is enabled but this is not given, OutputDir is used.
        /// Switch: --rsocket_rpc_out=
        /// </summary>
        public string RSocketRpcOutputDir { get; set; }

        /// <summary>
        /// RSocket RPC Codegen options. See also OptionsFromMetadata.
        /// --rsocket_rpc_opt=opt1,opt2=val (comma-separated).
        /// </summary>
        public string[] RSocketRpcOutputOptions { get; set; }
        ...
        protected override bool ValidateParameters()
        {
            ...
            if (RSocketRpcPluginExe == null)
            {
                RSocketRpcOutputOptions = null;
                RSocketRpcOutputDir = null;
            }
            else if (RSocketRpcOutputDir == null)
            {
                // Use OutputDir for RSocket RPC output if not specified otherwise by user.
                RSocketRpcOutputDir = OutputDir;
            }
        ...
        protected override string GenerateResponseFileCommands()
        {
            ...
            cmd.AddSwitchMaybe("plugin=protoc-gen-rsocket_rpc", RSocketRpcPluginExe);
            cmd.AddSwitchMaybe("rsocket_rpc_out", TrimEndSlash(RSocketRpcOutputDir));
            cmd.AddSwitchMaybe("rsocket_rpc_opt", RSocketRpcOutputOptions);
            if (ProtoPath != null)
            {
