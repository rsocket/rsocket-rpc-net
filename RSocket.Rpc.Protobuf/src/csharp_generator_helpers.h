...
#ifndef RSOCKET_RPC_COMPILER_CSHARP_GENERATOR_HELPERS_H
#define RSOCKET_RPC_COMPILER_CSHARP_GENERATOR_HELPERS_H
...
inline bool ServicesFilename(const google::protobuf::FileDescriptor* file,
  ...
  *file_name_or_error =
      FileNameInUpperCamel(file, false) + "RSocketRpc.cs";
  return true;
}
...
template <typename DescriptorType>
inline string GetCsharpComments(const DescriptorType* desc,
                                      bool leading) {
...
#endif  // RSOCKET_RPC_COMPILER_CSHARP_GENERATOR_HELPERS_H
